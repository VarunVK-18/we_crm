...
export class ChecklistDetails implements OnInit, OnDestroy {
  ...
  recommendationPool = [
    ...
    { category: 'Compliance', name: 'ISO Certification', desc: 'Obtain ISO certification with documentation and audit support services.', avgWorkingDays: '5–7 days', documentsRequired: ['Recent Invoice copy raised', 'Address Proof', 'Authorised Letter'], features: ['ISO Certificate via Courier'] },
    { category: 'Compliance', name: 'FSSAI Registration', desc: 'Register your food business and obtain the required FSSAI license.', avgWorkingDays: '1–3 days', documentsRequired: ['Company Incorporation documents', 'Proof of Business Address', 'NOC from Premises Owner'] }
  ];
  ...
  getServiceSpecificDocuments(): any[] {
    ...
    if (cl && cl.details) {
      const docArrays = [
        'dunsDocs', 'dpiitDocs', 'incorpDocs', 'trademarkDocs', 'llpDocs', 'msmeDocs', 
        'gstDocs', 'isoDocs', 'fssaiDocs', 'dscDocs', 'dynamicDocs', 'mcaDocs',
        'leiDocs', 'bisDocs', 'gstComplianceDocs', 'proprietorshipDocs', 'tdsDocs',
        'itrDocs', 'ceRohsDocs', 'pfDocs', 'patentDocs', 'gstCancellationDocs',
        'gstFilingDocs', 'iecDocs', 'copyrightDocs'
      ];
