...
class _DscFormScreenState extends ConsumerState<DscFormScreen> {
  ...
  void _autoFillFromProfile() {
    ...
    setState(() {
      ...
      if (_applicantMailController.text.isEmpty && user.email.isNotEmpty) _applicantMailController.text = user.email;
      if (_applicantPhoneController.text.isEmpty && user.phone.isNotEmpty) _applicantPhoneController.text = user.phone;
    });
  }
@override
