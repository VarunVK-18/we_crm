...
class _IecFormScreenState extends ConsumerState<IecFormScreen> {
  ...
  void _autoFillFromProfile() {
    ...
    if (user == null) return;
    setState(() {
      if (_applicantFirstNameController.text.isEmpty && user.name.isNotEmpty) _applicantFirstNameController.text = user.name;
      if (_applicantEmailController.text.isEmpty && user.email.isNotEmpty) _applicantEmailController.text = user.email;
      if (_applicantMobileController.text.isEmpty && user.phone.isNotEmpty) _applicantMobileController.text = user.phone;
    });
  }
