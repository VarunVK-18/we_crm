...
class _ProprietorshipFormScreenState extends ConsumerState<ProprietorshipFormScreen> {
  ...
  void _autoFillFromProfile() {
    ...
    if (user == null) return;
    setState(() {
      if (_proprietorNameController.text.isEmpty && user.name.isNotEmpty) _proprietorNameController.text = user.name;
                ...
                children: [
                  ...
                  _buildSectionContainer(
                    ...
                    children: [
                      ...
                      _buildField('Applicant PAN Number', '', _panNumberController, isRequired: true, validator: (v) => ValidationUtils.isValidPan(v) ? null : 'Enter a valid PAN'),
