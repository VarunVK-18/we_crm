      ...
      if (mounted) {
        ...
        if (draft.containsKey('isVerified')) {
          ...
          _isVerified = val is bool ? val : val == 'true';
                ...
                if (draft.containsKey('udyamCertPath')) _udyamCertPath = draft['udyamCertPath'];
        if (draft.containsKey('trademarkLogoPath')) _trademarkLogoPath = draft['trademarkLogoPath'];
        if (draft.containsKey('signaturePath')) _signaturePath = draft['signaturePath'];
});
      }
    }
  }
  ...
  Future<void> _saveDraft() async {
    ...
    final data = <String, dynamic>{
      ...
      'isVerified': _isVerified.toString(),
          ...
          'udyamCertPath': _udyamCertPath,
      'trademarkLogoPath': _trademarkLogoPath,
