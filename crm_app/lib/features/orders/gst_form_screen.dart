...
class _GstFormScreenState extends ConsumerState<GstFormScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('GST Registration Form', style: TextStyle(color: Colors.black, fontWeight: FontWeight.w800, fontSize: 16)),
        backgroundColor: Colors.white,
        elevation: 0,
                ...
                children: [
                  ...
                  _buildSectionContainer(
                    ...
                    children: [
                      ...
                      _buildField('Date of commencement of Business', 'MM/DD/YYYY', _commenceDateController, isRequired: true),
                  ...
                  _buildSectionContainer(
                    ...
                    children: [
                      ...
                      _buildField('DOB', 'MM/DD/YYYY', _dobController, isRequired: true),
