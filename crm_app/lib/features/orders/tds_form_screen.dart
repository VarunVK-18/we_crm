...
class _TdsFormScreenState extends ConsumerState<TdsFormScreen> {
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      appBar: AppBar(
        title: const Text('TDS / TAN Registration Form', style: TextStyle(color: Colors.black, fontWeight: FontWeight.w800, fontSize: 16)),
        backgroundColor: Colors.white,
        elevation: 0,
                ...
                children: [
                  ...
                  _buildSectionContainer(
                    ...
                    children: [
                      ...
                      _buildFileRow('Address Proof', 'Authorized Signatory Proof. Max 2 MB.', _addressProofPath, () => _pickFile((path) => _addressProofPath = path)),
