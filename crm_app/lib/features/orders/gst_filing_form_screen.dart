    ...
    if (draft != null) {
      if (mounted) {
        ...
        if (draft.containsKey('quarter')) _filingQuarter = draft['quarter'];
                ...
                if (draft.containsKey('salesReportPath')) _salesReportPath = draft['salesReportPath'];
        if (draft.containsKey('purchaseReportPath')) _purchaseReportPath = draft['purchaseReportPath'];
        if (draft.containsKey('gstInvoicesPath')) _gstInvoicesPath = draft['gstInvoicesPath'];
});
      }
    }
  }
  ...
  Future<void> _saveDraft() async {
    ...
    final data = <String, dynamic>{
      ...
      'quarter': _filingQuarter ?? '',
          ...
          'salesReportPath': _salesReportPath,
      'purchaseReportPath': _purchaseReportPath,
      'gstInvoicesPath': _gstInvoicesPath,
};
