...
class _IecFormScreenState extends ConsumerState<IecFormScreen> {
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      appBar: AppBar(
        title: const Text('IEC Registration Form', style: TextStyle(color: Colors.black, fontWeight: FontWeight.w800, fontSize: 16)),
        backgroundColor: Colors.white,
        elevation: 0,
                ...
                children: [
                  ...
                  _buildSectionContainer(
                    ...
                    children: [
                      ...
                      _buildFileRow('Address Proof', 'Aadhaar/Utility Bill. Max 2 MB.', _addressProofPath, () => _pickFile((path) => _addressProofPath = path)),
